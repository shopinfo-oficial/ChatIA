...
let customSessionId = localStorage.getItem("customSessionId"),
  ...
  isVishPinou = "true" === localStorage.getItem("isVishPinou");
const agora = new Date(),
  expirou = !dataHora || agora - new Date(dataHora) > 864e5;
expirou &&
...
const chat = createChat({
  ...
  webhookConfig: {
    method: "POST",
    headers: { customSessionId: customSessionId, isVishPinou: isVishPinou },
  },
  metadata: { customSessionId: customSessionId, isVishPinou: isVishPinou },
  mode: "window",
...
function initializeChatUI() {
  ...
  n.classList.add("chat-backdrop-invisible"), document.body.appendChild(n);
  const o = document.createComment("toggle-anchor");
  function a() {
    const e = document.querySelector(".chat-header"),
      n = e?.querySelector(".chat-info");
    e &&
      n &&
      t &&
    ...
    t.addEventListener("click", async function () {
      e.classList.contains("is-open")
        ? (i(),
          setTimeout(async () => {
            try {
              if ("true" === localStorage.getItem("feedbackEnviado")) return;
              const e = await getChatHistory();
              Array.isArray(e) && e.length > 0 && showFeedbackModal();
            } catch (e) {}
          }, 150))
        : (e.classList.add("is-open"), a());
    }),
    n.addEventListener("click", i);
  const r = document.querySelector(".close-button");
  function a() {
    const e = document.querySelector(".chat-header"),
      n = e?.querySelector(".chat-info");
    e &&
  ...
  r && r.addEventListener("click", i),
    e.classList.contains("is-open") ? a() : s(),
    (function () {
      const t = document.querySelector(".chat-header");
      if (!t) return;
      const n = "IA Simon Assist",
        o = n;
      (t.innerHTML = `\n      <div class="chat-info">\n        <img src="https://media.istockphoto.com/id/1634258551/pt/vetorial/ai-icon-artificial-intelligence-logo-machine-learning-generate-image-amd-text-sign.jpg?s=612x612&w=0&k=20&c=okv6FCtGF2SnfKfSNZMU8EHCzp4QFtIumVO2OKWTWx0=" />\n        <div class="chat-heading">\n          <h1>${o}</h1>\n          <div class="chat-status"><div class="status-dot"></div> Simon AI está online</div>\n        </div>\n      </div>\n    `),
        (function (e) {
          ...
          if (t) {
            ...
            n.innerHTML = o;
            const a = t.querySelector(".chat-messages-list");
            a ? t.insertBefore(n, a) : t.appendChild(n);
          }
        })(o),
        e.classList.contains("is-open") && a();
    })();
}
function CTA() {
  function e(e) {
      ...
      setTimeout(() => {
        ...
        e &&
          e.addEventListener("click", function () {
            const e = document.querySelector(".chat-window-wrapper"),
              t = document.querySelector(".chat-window-toggle");
            sendProductToBackend(getOnlyTextFromBody()),
              e && t
                ? (e.classList.contains("is-open")
  ...
  !(function () {
    const e = setInterval(() => {
      const t = document.querySelector(".empty-search__title .container > div"),
        n = t?.querySelector("p"),
        o = t?.querySelector("a.call-to-action");
      if (t && n && o && !document.querySelector("#simon-help-box")) {
        clearInterval(e), localStorage.setItem("isVishPinou", "true");
        const t = document.createElement("div");
        (t.id = "simon-help-box"),
          (t.style.cssText =
          ...
          n.insertAdjacentElement("afterend", t);
        t.querySelector("#btn-open-simon-chat").addEventListener(
          "click",
          () => {
            const e = document.querySelector(".chat-window-wrapper"),
              t = document.querySelector(".chat-window-toggle");
  ...
  const t = window.innerWidth <= 768,
    n = setInterval(() => {
      !t &&
        ...
        (!(function () {
          var t = document.querySelector(".container > div > p"),
            n = document.querySelector(".container > div > a.call-to-action");
          if (t && n) {
            if (document.querySelector("#simon-help-box")) return;
            var o = e(window.innerWidth <= 768);
            return void t.insertAdjacentElement("afterend", o);
          }
          const a = document.querySelector(
            ".productDescription-hexagon.mobile-notshow"
          );
          if (!a || document.querySelector("#simon-help-box")) return;
          const s = document.createElement("div");
          (s.className = "productDescription-hexagon mobile-notshow"),
            (s.style.top = "545px"),
          ...
          if (
            ...
            !document.querySelector("#simon-cta-desktop-style"))
          ) {
            const e = document.createElement("style");
            (e.id = "simon-cta-desktop-style"),
              (e.textContent =
...
async function sendProductToBackend(e) {
  const t = localStorage.getItem("customSessionId"),
    n = localStorage.getItem("dataHora"),
    o = localStorage.getItem("isVishPinou"),
    a = window.location.href,
    s = JSON.parse(localStorage.getItem("pageSessionData") || "{}")[a] || {},
    i = {
      sessionId: t || null,
      pageInfo: {
        id: s.id || null,
        dataHora: s.dataHora || n || null,
        url: a,
        isVishPinou: "true" === o,
      },
      pageText: e,
...
function getOnlyTextFromBody() {
  let e,
    ...
    n = [];
  for (; (e = t.nextNode()); ) n.push(e.nodeValue.trim());
  let o = n.join(" ");
...
async function getChatHistory() {
  ...
  function n(n, o) {
    var a = e(
      "div",
      "chat-message " +
        ("bot" === n ? "chat-message-from-bot" : "chat-message-from-user")
    );
    a.setAttribute("data-msg-key", t(n, o)),
      a.setAttribute("data-history", "1");
    var s = e("div", "chat-message-actions");
    a.appendChild(s);
    var i = e("div", "chat-message-markdown"),
      r = e("p", "");
    return (r.textContent = o || ""), i.appendChild(r), a.appendChild(i), a;
  }
  function o(e, n, o) {
    var a = t(n, o),
      s = '[data-msg-key="' + CSS.escape(a) + '"]';
    return null !== e.querySelector(s);
  }
  var a = localStorage.getItem("customSessionId");
  if (!a)
    return (
  ...
  try {
    ...
    var i = await s.json(),
      r = Array.isArray(i) ? i[0] && i[0].history : i && i.history;
    if (!Array.isArray(r) || !r.length) return [];
    var c = r.slice().reverse(),
      d = document.querySelector(".chat-messages-list");
    if (!d)
      return console.warn("⚠️ Container .chat-messages-list não encontrado"), c;
    for (var l = !1, m = 0; m < c.length; m++) {
      var u = c[m] || {},
        p = null != u.Q ? String(u.Q) : "",
        h = null != u.A ? String(u.A) : "";
      if ((p && !o(d, "user", p)) || (h && !o(d, "bot", h))) {
        l = !0;
        break;
      }
    }
    if (!l) return c;
    for (var f = document.createDocumentFragment(), g = 0; g < c.length; g++) {
      var y = c[g] || {},
        b = null != y.Q ? String(y.Q) : "",
        x = null != y.A ? String(y.A) : "";
      b && !o(d, "user", b) && f.appendChild(n("user", b)),
        x && !o(d, "bot", x) && f.appendChild(n("bot", x));
    }
    return d.prepend(f), (d.scrollTop = d.scrollHeight), c;
  } catch (e) {
...
function showFeedbackModal() {
  ...
  (n.innerHTML = "✖"),
    ...
    (n.onmouseenter = () => (n.style.color = "#fff")),
    (n.onmouseleave = () => (n.style.color = "#888"));
  const o = document.createElement("h3");
  (o.textContent = "O Simon conseguiu te ajudar?"),
    (o.style.cssText =
  ...
  (i.textContent = "Sim 😄"),
    ...
    (i.onmouseenter = () => (i.style.filter = "brightness(1.2)")),
    (i.onmouseleave = () => (i.style.filter = "brightness(1)"));
  const r = document.createElement("button");
  (r.textContent = "Não 😕"),
    (r.style.cssText =
      "\n    background: linear-gradient(90deg,#ff4d4d,#a80000);\n    color: #fff;\n    border: none;\n    padding: 10px 22px;\n    border-radius: 8px;\n    cursor: pointer;\n    font-weight: 700;\n    font-size: 14px;\n    transition: all 0.25s ease;\n    box-shadow: 0 0 10px rgba(255,0,0,0.3);\n  "),
    (r.onmouseenter = () => (r.style.filter = "brightness(1.2)")),
    (r.onmouseleave = () => (r.style.filter = "brightness(1)")),
    s.append(i, r),
    t.append(n, o, a, s),
    e.appendChild(t),
  ...
  (c.textContent =
    ...
    i.addEventListener("click", async () => {
      await sendFeedback("sim"), l("Valeu pelo feedback 💚");
    }),
    r.addEventListener("click", async () => {
      await sendFeedback("nao"), l("Feedback recebido 💪");
    });
}
...
function managePageSession() {
  ...
  if (!o || new Date() - new Date(o) > 864e5) localStorage.removeItem(t);
  else if (!n[e]) {
    const a = crypto.randomUUID();
    (n[e] = { id: a, dataHora: o }), localStorage.setItem(t, JSON.stringify(n));
  }
}
function monitorarLinksShopinfo() {
  const e = document.querySelector(".chat-messages-list");
  if (!e) return;
  function t() {
    e.querySelectorAll(
      ".chat-message-from-bot .chat-message-markdown p"
    ).forEach((e) => {
      if ("true" === e.dataset.botaoCriado) return;
      const t = e.textContent,
        n = t.match(/(https:\/\/[^\s]+?\.(png|jpg|jpeg|webp)(\?[^ )]+)?)/i);
      if (n) {
        const t = n[0],
          o = document.createElement("img");
        return (
          (o.src = t),
          (o.alt = "Imagem do produto"),
          (o.style.cssText =
            "\n            width: 100%;\n            height: auto;\n            border-radius: 8px;\n            margin: 10px 0;\n            display: block;\n          "),
          e.replaceWith(o),
          void (e.dataset.botaoCriado = "true")
        );
      }
      const o = t.match(/https:\/\/www\.shopinfo\.com\.br[^\s)]+/g);
      if (o) {
        const t = o[0],
          n = document.createElement("a");
        (n.href = t),
          (n.target = "_blank"),
          (n.textContent = "🛒 VER PRODUTO"),
          (n.style.cssText =
            "\n            display:block;\n            text-align:center;\n            background:linear-gradient(90deg,#00ffa3,#00c0ff);\n            color:#000;\n            padding:12px 20px;\n            border-radius:8px;\n            font-weight:700;\n            text-decoration:none;\n            margin:0px;\n            width:fit-content;\n            font-family:'Roboto',sans-serif;\n            box-shadow:0 0 12px rgba(0,255,170,0.4);\n            transition:all .3s ease;\n          "),
          (n.onmouseenter = () => (n.style.filter = "brightness(1.2)")),
          (n.onmouseleave = () => (n.style.filter = "brightness(1)")),
          e.replaceWith(n);
      }
      e.dataset.botaoCriado = "true";
    });
  }
  t();
...
initializeChatUI(),
  ...
  setTimeout(monitorarLinksShopinfo, 2e3);
